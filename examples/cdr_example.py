...
for i in [50, 100]:
    cdr_model.append(
        cornac.models.CDR(name="CDR_e{}".format(i),
                          k=50, autoencoder_structure=[200], max_iter=i, batch_size=128,
                          lambda_u=0.01, lambda_v=0.1, lambda_w=0.0001, lambda_n=5,
                          learning_rate=0.001, vocab_size=8000, loss_func="squared")
    )

# cdr = cornac.models.CDR(k=50, autoencoder_structure=[200], max_iter=30, batch_size=128,
#                         lambda_u=0.01, lambda_v=0.1, lambda_w=0.0001, lambda_n=5,
#                         learning_rate=0.001, vocab_size=8000, loss_func="squared")
