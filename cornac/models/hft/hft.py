...
class Model:
    ...
    def __init__(self, params, n_user, n_item, n_vocab, k=10,
        ...
        self.gamma_u, self.gamma_i = self._get_view(params)  # Parameter views
        # Counter
    ...
    def update_params(self, rating_data):
        ...
        self.gamma_u, self.gamma_i = self._get_view(self.params)
    ...
    def _get_view(self, params):
        ...
        gamma_u = params[:idx[0]].reshape(self.n_user, self.k)
        gamma_i = params[idx[0]:].reshape(self.n_item, self.k)
