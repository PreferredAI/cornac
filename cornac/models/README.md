...
| [Collaborative Filtering for Implicit Feedback Datasets (CF)](cf), [paper](http://yifanhu.net/PUB/cf.pdf) | [requirements.txt](cf/requirements.txt) | [cf_example.py](../../examples/cf_example.py)
