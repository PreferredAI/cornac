...
class NeuMF_PyTorch(NCFBase_PyTorch):
    """Neural Matrix Factorization.

    Parameters
    ----------
    num_factors: int, optional, default: None
        Embedding size of MF model. If None, it is set layers[-1].
    ...
    use_pretrain: bool, optional, default: False
        Whether to use pretrained GMF model.
    ...
    def fit(self, train_set, val_set=None):
        ...
        from .pytorch_ncf_base import NeuMF_torch as NeuMF
